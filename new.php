...
type="text" name="user" value=" " size="24" maxlength="20"></div>
<div class="cell_pola_vxod"><div class="vxod_name">Password:</div><input class="login_pole"
type="password" name="password" size="24" maxlength="20"></div>
<div id="vxod_reg"><a href="$REMINDER_LINK$">Забыли пароль</a> | <a href="$REGISTER_LINK$">Регистрация</a>
