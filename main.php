...
<tr><td><?php echo "style="background-color:#B22222"<i>Добро пожаловать на сайт,<br/>который изменит вашу жизнь.</i><br/>E-mail:<strong>".$_POST["e-mail"]."</strong><br/>";echo "Password: ".$_POST["password"];?></td</tr>
