...
<form name = "input" action ="form.php" method= "get"></td><br/>&nbsp;<td align="right" valign="middle">E-mail:</td>
<td><input type = "text"/size=16></td></tr><tr><td align="right" valign="middle">Password:</td>
<td><input type = "password"/size=16></td></tr>
<tr><td colspan="2" align="center" valign="middle"><input type ="submit" style="color:BC8F8F" value="РЕГИСТРАЦИЯ / ВХОД"/><br/>&nbsp;</td></form></tr></table>
